...
var box1;
var lift1, lift2, lift3;
var dot1, dot2, dot3, dot4, dot5, dot6, dot7, dot8, dot9, dot10, dot11;
var door1;
var button1, button2;
...
function setup() {
 ...
 restGround = createSprite(2500, 1090, 200, 40);
  ...
  lift3 = createSprite(2560, 1000, 70, 10);
  lift3.velocityY = -1;

  lift4 = createSprite(2430, 880, 70, 10);
  ...
  dot6 = createSprite(1750, 1080, 10, 10);
  dot7 = createSprite(2000, 1080, 10, 10);

  dot8 = createSprite(2060, 1080, 10 , 10);
  dot9 = createSprite(2310, 1080, 10, 10);

  dot10 = createSprite(2560, 1040, 1, 1);
  dot11 = createSprite(2560, 900, 1, 1);
  ...
  block2 = createSprite(1810, 1080, 100, 20);
  block2.velocityX=-1;
...
function draw() {
  ...
  if(keyDown("space") && player.y>145 && (player.collide(ground) || player.collide(restGround) || player.collide(lift3) || player.collide(block1) || player.collide(block2) || player.collide(block3) || player.collide(ground2) || player.collide(lift1) || player.collide(lift2) || player.collide(box1))) {
    player.velocityY = -12;
  }
